...
class Creds(object):
    ...
    INCORRECT_CREDS = [
        (CORRECT_CREDS[0]["login"], RandGen.get_random_string(8)),
        (RandGen.get_random_string(8), CORRECT_CREDS[0]["password"]),
        (RandGen.get_random_string(8), RandGen.get_random_string(8)),
